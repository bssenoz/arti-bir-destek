                ...
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="d-flex justify-center">
                            <v-btn color="primary" class="mx-2" flat> Yükle</v-btn>
                            <v-btn color="error" class="mx-2" variant="outlined" flat>Sıfırla</v-btn>
                        </div>
                        <div class="text-subtitle-1 text-medium-emphasis text-center my-sm-8 my-6">Allowed JPG, GIF or
                            ...
                            <template v-slot:default="{ isActive }">
                                <v-card title="Bu işlem geri alınamaz!">
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn text="Hesabımı Sil" @click="currentDelete" class="bg-lighterror text-error"></v-btn>
                                    </v-card-actions>
                                </v-card>
                            </template>
                        </v-dialog>
