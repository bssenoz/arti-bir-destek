<template>
  <v-container>
    <v-row>
      <v-col v-for="(video, index) in videoData" :key="index" cols="12" sm="6" md="4">
        <Chart :title="video.title" :description="video.description" :watchPercentage="video.watchPercentage" />
      </v-col>
    </v-row>
    <v-row>
    <v-col>
